...
class ResNet(Module):
    ...
    def __init__(self, input_size, block, layers, zero_init_residual = True):
        ...
        assert input_size[0] in [112, 224, 248], "input_size should be [112, 112] or [224, 224]"
        self.inplanes = 64
...
def ResNet_18(input_size, **kwargs):
    ...
    """
    model = ResNet(input_size, Bottleneck, [1, 1, 1, 1], **kwargs)
...
def Palm_Qul(input_size, **kwargs):
    model = ResNet(input_size, Bottleneck, [1,1,1,1], **kwargs)
    return model
