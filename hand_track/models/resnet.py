...
#}
model_urls = {
    'resnet18': 'imagenet_pretrain/resnet18-5c106cde.pth',
    'resnet34': 'imagenet_pretrain/resnet34-333f7ec4.pth',
    'resnet50': 'imagenet_pretrain/resnet50-19c8e357.pth',
    'resnet101': 'imagenet_pretrain/resnet101-5d3b4d8f.pth',
    'resnet152': 'imagenet_pretrain/resnet152-b121ed2d.pth',
}
...
def resnet101(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        pretrained_state_dict = torch.load(model_urls['resnet101'])
        model = load_model(model, pretrained_state_dict)
    return model
...
def resnet152(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        pretrained_state_dict = torch.load(model_urls['resnet152'])
        model = load_model(model, pretrained_state_dict)
    return model
