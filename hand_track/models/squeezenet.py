...
#}
model_urls = {
     'squeezenet1_0': 'imagenet_pretrain/squeezenet1_0-a815701f.pth',
     'squeezenet1_1': 'imagenet_pretrain/squeezenet1_1-f364aa15.pth',
}
...
def squeezenet1_0(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        pretrained_state_dict = torch.load(model_urls['squeezenet1_0'])
...
def squeezenet1_1(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        pretrained_state_dict = torch.load(model_urls['squeezenet1_1'])
        pretrained_dict = {k: v for k, v in pretrained_state_dict.items() if
                       k in model_dict and model_dict[k].size() == pretrained_state_dict[k].size()}
        model.load_state_dict(pretrained_dict,strict=False)
    return model
